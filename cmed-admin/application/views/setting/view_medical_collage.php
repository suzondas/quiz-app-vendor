                    ...
                    <section class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <?php
                                if ($form_action == "add") {
                                $action_url = base_url() . 'setting/save_med_collage';
                                $btnval = 'SAVE';
                                } elseif ($form_action == "edit") {
                                    $action_url = base_url() . 'setting/update_med_collage';
                                    $btnval = 'UPDATE';
                                }
                                ...
                                <form class="cmxform form-horizontal " id="commentForm" role="form" method="post" action="<?php echo $action_url; ?>">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="name" name="collage_name" type="text" value="<?php echo isset($res->collage_name) ? $res->collage_name : ''; ?>" required/>
                                        </div>
                                    </div>                                           
                                    <div class="form-group ">
                                        <label for="Name" class="control-label col-lg-3 col-sm-3">Medical College Type</label>
                                        <div class="col-lg-6 col-sm-9">
                                            <?php

                                            $ddp = 'class="form-control m-bot15"';
                                            echo form_dropdown('collage_type', $collage_type,(isset($res->collage_type) ? $res->collage_type : ''), $ddp);
                                            ?>
                                        </div>
                                    </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($record)) {
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $value->collage_name; ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url().'setting/edit_med_collage_list/'.$value->id; ?>" class="btn btn-warning btn-xs" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil-square-o"></i></a>
