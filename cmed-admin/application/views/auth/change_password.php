            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form class="cmxform form-horizontal " id="commentForm" role="form" method="post"
                          action="<?php echo site_url( 'auth/change_password' ); ?>" enctype="multipart/form-data">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="password" name="old" class="form-control" required id="old_password">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="password" name="new" class="form-control" required id="new_password">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="password" name="new_confirm" class="form-control" required id="new_password">
