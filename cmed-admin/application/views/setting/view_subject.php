...
<!--                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6 col-sm-9">                                          
                                        <?php
                                        //$ddp = 'class="form-control m-bot15" id="subject_id" required';
                                       // echo form_dropdown('subject_id', $subject_list,(isset($res) ? $res->subject_id : ''), $ddp);
                                        ?>
                                    </div>
                                </div>-->
                                <div class="form-group ">
                                ...
                                if (!empty($record)) {
                                    ...
                                    foreach ($record as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url() . 'setting/edit_subject/' . $value->id; ?>" class="btn btn-warning btn-xs" title="Edit" data-toggle="tooltip" data-placement="top"
