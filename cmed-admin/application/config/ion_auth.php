...
*/
$config['tables']['users']           = 'sif_users';
$config['tables']['groups']          = 'sif_groups';
$config['tables']['users_groups']    = 'sif_users_groups';
$config['tables']['login_attempts']  = 'sif_login_attempts';
