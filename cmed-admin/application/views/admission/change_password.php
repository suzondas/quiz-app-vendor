		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<form class="cmxform form-horizontal " id="commentForm" role="form" method="post"
					...
					<input type="hidden" name="master_id" value="<?php echo isset( $res->master_id ) ? $res->master_id : ''; ?>">
						...
						<div class="panel-body">
							...
							<div class="form">
								...
								<div class="form-group">
									<label for="old_password" class="control-label col-lg-4">Name <i class="fa fa-asterisk ipd-star"></i></label>
									<div class="col-lg-6">
										<input type="text" name="old" class="form-control" required id="old_password" value="<?= $res->doc_name ?>" disabled>
										<i class="text-danger"><?= form_error( 'auto_id' ) ?></i>
									</div>
								</div>
								<div class="form-group">
									<label for="new_password" class="control-label col-lg-4">New Password <i class="fa fa-asterisk ipd-star"></i></label>
									<div class="col-lg-6">
										<input type="text" name="new" class="form-control" required id="new_password">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<input type="text" name="new_confirm" class="form-control" required id="new_password">
