				...
				<section class="panel panel-info">
					...
					<div class="panel-body">
						...
						<div class="text-right m-bot15">
							<a href="<?= site_url( 'notice/add_general_notice' ); ?>" class="btn btn-primary">Send New Notice</a>
						</div>
								...
								<?php foreach ( $notices as $i => $notice ) : ?>
									<tr>
										...
										<td class="text-center">
											...
											<a href="<?= site_url( "notice/edit_notice/$notice->id" ) ?>" class="btn btn-xs btn-warning">Edit</a>
											<a href="<?= site_url( "notice/delete_notice/$notice->id" ) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Notice will be deleted permanently. Are You Sure?')">Delete</a>
										</td>
									</tr>
								<?php endforeach; ?>
							<?php endif; ?>
