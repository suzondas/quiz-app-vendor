                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <?php
                                if($form_action == "add"){
                                    $action_url = base_url().'setting/save_exam_term';
                                }elseif($form_action == "edit"){
                                    $action_url = base_url().'setting/update_exam_term';
                                }
                                ?>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($record)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url().'setting/edit_exam_term/'.$value->id; ?>"><i class="fa fa-pencil-square-o"></i></a>
