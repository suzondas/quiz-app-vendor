        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if ( $form_action == "add" || $form_action == 'readmission' ) {
                    $action_url = base_url() . 'admission/save';
                    $btnval     = 'SAVE';
                } elseif ( $form_action == "edit" ) {
                    $action_url = base_url() . 'admission/update_admission';
                    $btnval     = 'UPDATE';
                }
                ?>
                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="commentForm" role="form"
                    ...
                    <section class="panel panel-info">
                        <header class="panel-heading">
                            ...
                            if ( $form_action == "add" ) {
                                ...
                                echo 'Edit Admission Form';
                            } else {
                                echo 'Readmission Form';
                            }
                            ?>
                        ...
                        <div class="panel-body">
                            <?php if ( $res->reg_no ) echo form_hidden( 'prev_reg', $res->reg_no ); ?>
                            <div class="form">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        if ( $res->year ) echo form_hidden( 'prev_year', $res->year );
                                    ...
                                    <div class="col-lg-4">
                                        <?php
                                        if ( $res->session ) echo form_hidden( 'prev_session', $res->session );
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            <input type="text" name="dob" class="form-control datepicker" value="<?= $res->dob; ?>" required readonly>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class=" form-control" id="hsc_ins" name="exam_ins[]"
                                                           type="text"
                                                           value="<?php echo isset( $edu_record[3] ) ? $edu_record[3]->exam_ins : '' ?>"/>
                                                </td>
                                                <td>
                                                    <?php
                                                    //$ddp = 'class="form-control" required';
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel panel-info">
                                <header class="panel-heading">
                                    Teaching Experience / Job Details
                                    <span class="tools pull-right">
                                        <a class="fa fa-chevron-down" href="javascript:;"></a>
                                        <a class="fa fa-cog" href="javascript:;"></a>
                                        <a class="fa fa-times" href="javascript:;"></a>
                    ...
                    <!--end teaching exp section--><!--start image section-->
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel panel-info">
                                <header class="panel-heading">
