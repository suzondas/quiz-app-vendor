                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="commentForm" role="form" method="post"
                                      action="<?php echo base_url() . 'payment/discount'; ?>">
                            ...
                            <section class="panel">
                                ...
                                <table class="table table-bordered m-bot15 text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= number_format($rec->discount_amont); ?> TK</td>
                                    ...
                                    if ($payments) :
                                        foreach ($payments as $payment) : ?>
                                            <tr>
                                                ...
                                                <td><?= number_format($payment->amount); ?> TK</td>
                                                <td></td>
                                ...
                                <div class="col-md-12">
                                    <form class="cmxform form-horizontal " id="commentForm" role="form" method="post"
                                          action="<?php echo base_url() . 'payment/save_discount'; ?>"
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="col-md-2 m-bot15">
                                                ...
                                                <label for="Name" class="control-label col-md-1">Amount <i
                                                        class="fa fa-asterisk ipd-star"></i></label>
                                                <div class="col-md-2 m-bot15">
                                                    <input type="number" name="amount" class="form-control">
                                                </div>
                                                <label for="Name" class="control-label col-md-1">Auth By <i
                                                        class="fa fa-asterisk ipd-star"></i></label>
                                                <div class="col-md-2 m-bot15">
