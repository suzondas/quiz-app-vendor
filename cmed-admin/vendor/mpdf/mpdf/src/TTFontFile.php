...
class TTFontFile
{
    ...
    var $MarkGlyphSets; // mPDF 5.7.1
    var $GlyphClassMarks; // mPDF 5.7.1
    var $GlyphClassLigatures; // mPDF 7.5.1
    ...
    var     $maxUni; // mPDF 5.7.1
    var     $sFamilyClass; // mPDF 5.7.1	var $panose;
    var     $sFamilySubClass;
    var     $sipset;
    var     $smpset;
    var     $_pos;
    ...
    var     $strikeoutSize; // mPDF 6
    var     $strikeoutPosition; // mPDF 6
    var     $name;
    var     $familyName;
    var     $styleName;
    var     $fullName;
