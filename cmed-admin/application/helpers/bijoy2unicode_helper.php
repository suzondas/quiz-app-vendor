...
/*
    ...
    Usage:      1. include 'bijoy2unicode_helper.php'
...
function proConversionMap()
{
    $proConversionMap = array('্্' => '্');
    return $proConversionMap;
}


function postConversionMap()
{
