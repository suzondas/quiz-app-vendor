                    ...
                    <section class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <?php
                                if ($form_action == "add") {
                                $action_url = base_url() . 'setting/save_exam';
                                $btnval = 'SAVE';
                                } elseif ($form_action == "edit") {
                                    $action_url = base_url() . 'setting/update_exam';
                                    $btnval = 'UPDATE';
                                }
                                ...
                                <form class="cmxform form-horizontal " id="commentForm" role="form" method="post" action="<?php echo $action_url; ?>">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="name" name="exam_name" type="text" value="<?php echo isset($res->exam_name) ? $res->exam_name : ''; ?>" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($record)) {
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                                <a href="<?php echo base_url().'setting/edit_exam_type/'.$value->id; ?>" class="btn btn-warning btn-xs" title="Edit" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil-square-o"></i></a>
